            ...
            <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-lg border border-slate-100">
                <div>
                    ...
                    <p className="mt-2 text-center text-sm text-slate-600">
                        Sign in to use the AI Component Generator
                    </p>
                </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="appearance-none block w-full px-3 py-3 pr-10 border border-slate-300 placeholder-slate-500 text-slate-900 rounded-lg focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm"
                                    placeholder="••••••••"
                                />
                                <button
                                    type="button"
                                    onClick={() => setShowPassword(!showPassword)}
                                    className="absolute inset-y-0 right-0 top-0 bottom-0 pr-3 flex items-center text-slate-400 hover:text-slate-600 focus:outline-none z-20 cursor-pointer"
                                    tabIndex="-1"
                                >
                                    {showPassword ? (
